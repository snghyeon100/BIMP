...
# -*- coding: utf-8 -*-
"""
train_embedding.py  —  Training script for DSS_Base_Embedding model.
(Personalized Weighted Bundle Embedding using inner product: α_u,i = e_UI_u · e_UI_i)
"""
...
from models.DSS_Base_Embedding import DSS_Base as DSS
...
def get_cmd():
    ...
    parser.add_argument("-m", "--model",   default="DSS_Base_Embedding", type=str)
