...
# -*- coding: utf-8 -*-
"""
train_fam2_embedding.py  —  Training script for DSS_Fam2_Embedding model.
(Personalized Weighted Bundle Embedding using inner product for both Fam and Novel, with user-specific beta)
"""
...
from models.DSS_Fam2_Embedding import DSS_Base as DSS
...
def get_cmd():
    ...
    parser.add_argument("-m", "--model",   default="DSS_Fam2_Embedding", type=str)
