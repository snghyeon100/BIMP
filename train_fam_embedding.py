...
# -*- coding: utf-8 -*-
"""
train_fam_embedding.py  —  Training script for DSS_Fam_Embedding model.
(Personalized Weighted Bundle Embedding using inner product for both Fam and Novel)
"""
...
from models.DSS_Fam_Embedding import DSS_Base as DSS
...
def get_cmd():
    ...
    parser.add_argument("-m", "--model",   default="DSS_Fam_Embedding", type=str)
