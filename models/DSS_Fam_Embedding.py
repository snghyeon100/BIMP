...
# -*- coding: utf-8 -*-
"""
DSS_Fam_Embedding.py  —  Personalized Weighted Bundle Embedding.
Familiar/Novel Dual-head Attention based on Embedding Inner Product

Score(u, b) = e_UI_u · v*_u,b  +  e_UB_u · e_UB_b

v*_u,b = β · v_trust_u,b + (1-β) · v_motive_u,b
v_trust_u,b  = Σ_i softmax(α_u,i) · e_UI_i   (familiar)
v_motive_u,b = Σ_i softmax(-α_u,i) · e_UI_i  (novel)
...
class DSS_Base(nn.Module):
    ...
    def _score_all_bundles(self, embs, users):
        ...
        for u_start in range(0, bs, USER_CHUNK):
            ...
            ub_score = torch.mm(UB_u_chunk, UB_b.t())  # [uc, NB]
