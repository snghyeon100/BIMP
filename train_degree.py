...
# -*- coding: utf-8 -*-
"""
train_degree.py  —  Training script for DSS_Base_Degree model.
(Personalized Weighted Bundle Embedding: v*_u,b = softmax(Y_UI + λ·Y_UB×Y_BI) · e_i)
"""
...
def get_cmd():
    ...
    parser.add_argument("-m", "--model",   default="DSS_Base_Degree", type=str)
...
def main():
    ...
    for lr, l2_reg, UB_ratio, UI_ratio, BI_ratio, emb_size, num_layers, c_lambda, c_temp in \
        ...
        # ------------------------------------------------------------------
        # Post-training note: run analyze_degree.py for attention statistics
        # ------------------------------------------------------------------
        print("\n" + "=" * 60)
